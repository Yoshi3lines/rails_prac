...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/oauth-xx/oauth2/issues", "changelog_uri" => "https://github.com/oauth-xx/oauth2/blob/v2.0.5/CHANGELOG.md", "documentation_uri" => "https://www.rubydoc.info/gems/oauth2/2.0.5", "homepage_uri" => "https://github.com/oauth-xx/oauth2", "rubygems_mfa_required" => "true", "source_code_uri" => "https://github.com/oauth-xx/oauth2/tree/v2.0.5", "wiki_uri" => "https://github.com/oauth-xx/oauth2/wiki" } if s.respond_to? :metadata=
